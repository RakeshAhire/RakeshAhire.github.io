  ...
  return (
    <>
      ...
      <Flex w={{ base: '70%', md: '80%', lg: '30%' }} m='auto' mt={{ base: '15px', md: '25px' }} justifyContent='center' alignItems='center'>
        <Box>
          <a href="https://github.com/RakeshAhire">
            <Image width={{ base: '250px', md: '260px', lg: '350px' }} src={`https://github-readme-stats.vercel.app/api/top-langs/?username=rakeshahire&theme=${Theme === 'light' ? 'buefy' : 'midnight-purple'}&show_icons=true&count_private=true`} />
          </a>
        </Box>
      </Flex>
